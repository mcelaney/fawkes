...
# FawkesWeb.Endpoint.init/2 when load_from_system_env is
...
config :fawkes, FawkesWeb.Endpoint,
  ...
  url: [scheme: "https", host: "rocky-headland-97134.herokuapp.com", port: 443],
...
config :arc, bucket: Map.fetch!(System.get_env(), "S3_BUCKET")
...
# start per endpoint:
#
#     config :fawkes, FawkesWeb.Endpoint, server: true
#
